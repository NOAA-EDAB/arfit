...
where $\epsilon_t = \phi\epsilon_{t-1} + Z_t$ is a stationary first order autoregressive process with $Z_t \sim N(0,\sigma^2)$. Interest centers on testing the null hypothesis, $H_0:\beta = 0$ against the alternative, $H_1:\beta \neq 0$
